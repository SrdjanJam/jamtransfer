...
<form id="userEditForm{{AuthUserID}}" class="form box box-info" enctype="multipart/form-data" method="post" onsubmit="return false;">
	...
	<div class="box-header">
		...
		<div class="box-tools pull-right">
			...
			<button id='OwnerID2' class="btn btn-danger" title="Set Driver" >
	...
	<div class="box-body ">
		...
		<div  class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li><a href="#tab_2" data-toggle="tab"><?= SURCHARGES ?></a></li>
            </ul>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="row">
								...
								<div class="col-md-9">
									<strong id='DriverID'>{{AuthUserID}}</strong> 
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-md-9">
									<strong id='AuthUserName'>{{AuthUserName}}</strong> 
								</div>
							</div>
				...
				<div class="tab-pane" id="tab_2">
					<div class="row">
						...
						<div class="col-md-9">
							...
							onchange="globalSurcharges(<?=$_SESSION['UseDriverID'];?>);">
								{{#select SurCategory}}
					...
					<div id="globalSurcharges<?=$_SESSION['UseDriverID'];?>"></div>
	...
	<script>
		$('#OwnerID2').click(function(){
			var id=$( "#DriverID" ).text();			
			$('.listTile').each(function(){
				var user_id1='user_'+id;
				var user_id=$(this).attr('id');
				if (user_id!=user_id1) $(this).hide(500);
			})
