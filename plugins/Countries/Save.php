...
if ($keyName != '' and $keyValue != '') $db->getRow($keyValue);
	...
	if(isset($_REQUEST['CountryNameSE'])) { $db->setCountryNameSE($db->myreal_escape_string($_REQUEST['CountryNameSE']) ); } 

		 	
	if(isset($_REQUEST['CountryNameNO'])) { $db->setCountryNameNO($db->myreal_escape_string($_REQUEST['CountryNameNO']) ); } 

		 	
	if(isset($_REQUEST['CountryNameES'])) { $db->setCountryNameES($db->myreal_escape_string($_REQUEST['CountryNameES']) ); } 

		 	
	if(isset($_REQUEST['CountryNameNL'])) { $db->setCountryNameNL($db->myreal_escape_string($_REQUEST['CountryNameNL']) ); } 
	...
	if(isset($_REQUEST['CountryDescSE'])) { $db->setCountryDescSE($db->myreal_escape_string($_REQUEST['CountryDescSE']) ); } 

		 	
	if(isset($_REQUEST['CountryDescNO'])) { $db->setCountryDescNO($db->myreal_escape_string($_REQUEST['CountryDescNO']) ); } 

		 	
	if(isset($_REQUEST['CountryDescES'])) { $db->setCountryDescES($db->myreal_escape_string($_REQUEST['CountryDescES']) ); } 

		 	
	if(isset($_REQUEST['CountryDescNL'])) { $db->setCountryDescNL($db->myreal_escape_string($_REQUEST['CountryDescNL']) ); } 
