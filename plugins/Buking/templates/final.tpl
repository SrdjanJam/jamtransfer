...
<form method="post" id="finalForm" name="finalForm" action="index.php?p=agentThankyou"
        ...
        <div class="row">
            <div class="row xz-depth-3 white xxwhite-text">
                ...
                <div class="col l8 s12 xoffset-l3 xwhite">
                    ...
                    <div class="col s6 l9">
                        {$VehicleCapacity}<i class="fa fa-user"></i>
                    </div>
        ...
        <div class="row grey lighten-4 pad1em z-depth-1 ">
            ...
            <div class="col s12 l4 ">
                <div class="chip blue white-text center z-depth-1">
                    {$PICKUP_DATE}: {$transferDate} <small>(Y-M-D)</small>
                </div>
            </div>

            <div class="col s12 l4">
                <div class="chip blue white-text center z-depth-1">
                    {$PICKUP_TIME}: {$transferTime} <small>(H:M 24h)</small>
                </div>
            </div>
...
<div id="Summary"></div>
*/
require_once $_SERVER["DOCUMENT_ROOT"]."/cms/t/final.js.php";
