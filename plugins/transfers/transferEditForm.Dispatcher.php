...
<!--br> {{vehicleTypeSelect details.VehicleTypeName}} -->
					...
					{{!-- right side --}}
						...
						<div class="col-md-6">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<button class="btn btn-primary" data-toggle="modal" data-target="#routeDriversModal"><i class="fa fa-search"></i></button>
								</div>
							</div>
								...
								<div class="modal-dialog" style="width:800px">
									<div class="modal-content">
										...
										<div class="modal-body" style="padding:10px">
											...
											{{listDriversByRoute details.PickupID details.DropID}}
										</div>
	...
	<script>
		...
		// promijeni tip vozila pri promjeni vozaca
		function select (OwnerID, VehicleTypeID, VehicleTypeName) {
			document.getElementById("DriverSelect").value = OwnerID;
			$('#VehicleType').val(VehicleTypeID);
			applyChangeDriver(DriverSelect);
