...
<form id="transferEditForm{{details.DetailsID}}" class="form box box-solid" onsubmit="return false;">
	...
	<input type="hidden" name="PickupDate" id='PickupDate' value="{{details.PickupDate}}">
	...
	<div class="box-header">
		...
		<div class="box-tools pull-right">
			...
			<? $josko_array=array(2828,2831,556);
				if (in_array($SAuthUserID, $josko_array)) {?>			
			...
			{{#compare details.InvoiceAmount "==" 0}}
		        ...
		        <a href="index.php?p=racun&id={{details.DetailsID}}" class="btn btn-success"  
...
*/
					...
					{{!-- right side --}}
						...
						<div class="col-md-6">
							...
							<? if ($contractFile=='inter') { ?>
								...
								<div class="row">
									<div class="col-md-2"><label><?= STAFF_NOTE ?></label></div>
									<div class="col-md-8">
										<input class="form-control" type="text" 
										name="StaffNote" id="StaffNote" value="{{details.StaffNote}}" >
									</div>								
								</div>

								<div class="row">
									<div class="col-md-2"><label><?= NOTES_TO_DRIVER ?></label></div>
									<div class="col-md-8">
										<input class="form-control" type="text" 
										name="SubDriverNote" id="SubDriverNote" value="{{details.SubDriverNote}}" >
									</div>								
								</div>	
								
								<div class="row" id='ob' style='display:none'>
									<div class="col-md-2 "><label>Other bookings</label></div>
									<div class="col-md-8" id='otherTransfers'></div>									
								</div>	
	...
	{{#compare details.DriverConfStatus "<" 4}}
		{{#compare details.DriverConfStatus ">" 1}}
			{{#compare details.TransferStatus "!=" 3}}
				<button id='mac' class="btn btn-default" onclick="return completedTransfer('{{details.DetailsID}}','');" >		 
	...
	<input type="hidden"  id="PassengerEmail" name="MPaxEmail" value="{{master.MPaxEmail}}" >
