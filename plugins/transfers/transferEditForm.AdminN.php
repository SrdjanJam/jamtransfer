...
<script type="text/x-handlebars-template" id="transferTemplate">
						...
						<div class="row">
							...
							<div class="col-md-6">						
								...
								<div class="row">
									...
									<div class="col-md-9">
										<img id='agentimage2' src='' onerror="this.style.display = 'none';"><strong>{{userName details.UserID "AuthUserCompany"}}</strong>({{details.UserID}})
									</div>
								</div>
								
								<div class="row" id='ob' style='display:none'>
									<div class="col-md-3 "><label>Other booking</label></div>
	...
	$("#DetailPrice, #PayNow, #PayLater, #InvoiceAmount").change(function(){	
		$('#cpr').show(500);
	})
