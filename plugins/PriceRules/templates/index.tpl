	...
	<div class="box-body ">
        <div class="row">
			<div class="col-md-12">
						...
						<input type="text" name="OwnerID" id="OwnerID" class="w100" value="{$smarty.session.UseDriverID}" readonly>
						<input type="text" name="DriverRouteID" id="DriverRouteID" class="w100" value="{$item}" readonly>
