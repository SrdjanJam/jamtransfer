<script type="text/javascript">
	...
	function all_v4_SubExpenses() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_SubExpenses/v4_SubExpenses_All.php?where='+where+
	...
	function one_v4_SubExpenses(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_SubExpenses/v4_SubExpenses_One.php?ID='+id;
	...
	function editSavev4_SubExpenses(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_SubExpenses/'+
