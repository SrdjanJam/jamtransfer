...
if ($keyName != '' and $keyValue != '') $db->getRow($keyValue);
	...
	if(isset($_REQUEST['PlaceTypeSE'])) { $db->setPlaceTypeSE($db->myreal_escape_string($_REQUEST['PlaceTypeSE']) ); } 

		 	
	if(isset($_REQUEST['PlaceTypeNO'])) { $db->setPlaceTypeNO($db->myreal_escape_string($_REQUEST['PlaceTypeNO']) ); } 

		 	
	if(isset($_REQUEST['PlaceTypeES'])) { $db->setPlaceTypeES($db->myreal_escape_string($_REQUEST['PlaceTypeES']) ); } 

		 	
	if(isset($_REQUEST['PlaceTypeNL'])) { $db->setPlaceTypeNL($db->myreal_escape_string($_REQUEST['PlaceTypeNL']) ); } 
