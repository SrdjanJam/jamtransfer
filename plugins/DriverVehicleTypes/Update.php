...
if (isset($_REQUEST['PriceKm'])) $result = $dbT->RunQuery("UPDATE `v4_Vehicles` SET `PriceKm`='".$_REQUEST['PriceKm']."' WHERE `VehicleTypeID`=".$_REQUEST['VehicleTypeID']." AND `OwnerID`=".$_SESSION['UseDriverID']);
