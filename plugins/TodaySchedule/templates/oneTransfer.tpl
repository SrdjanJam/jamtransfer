		...
		<div class="row"> <!-- TRANSFER --> 
			...
			<strong>
				<a href="orders/detail/{$sdArray[pom].Transfers[pom2].DetailsID}" target="_blank">
					{$sdArray[pom].Transfers[pom2].OrderID}-{$sdArray[pom].Transfers[pom2].TNo}
				</a>
				{$sdArray[pom].Transfers[pom2].PickupName} - {$sdArray[pom].Transfers[pom2].DropName}
			</strong>	
		</div>
		<div class="row">
			...
			<div class="col-md-3 col-md-3-edit-add">
				{if $sdArray[pom].DriverID eq $sdArray[pom].Transfers[pom2].SubDriver and $sdArray[pom].Transfers[pom2].SubDriver2 gt 0}<span class='blink'>1.driver</span>{/if}
				{if $sdArray[pom].DriverID eq $sdArray[pom].Transfers[pom2].SubDriver2}<span class='blink'>2.driver</span>{/if}
				{if $sdArray[pom].DriverID eq $sdArray[pom].Transfers[pom2].SubDriver3}<span class='blink'>3.driver</span>{/if}	
			</div>
