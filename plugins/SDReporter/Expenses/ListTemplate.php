...
<div class="nav-tabs-custom nav-tabs-custom-edit">
	<div>
		<div class='row'>
			<div class="col-md-2">
				<input type="checkbox" id="card" name="card" style="height: 0.8em" value="" <? if ($cash) {?>checked<?}?>> Cash
			</div>

			<div class="col-md-2">
				<input type="checkbox" id="approved" name="approved" style="height: 0.8em" value="" <? if ($approved) {?>checked<?}?>> Approved
			</div>
			
			<div class="col-md-2">
				<input type="checkbox" id="unapproved" name="unapproved" style="height: 0.8em" value="" <? if ($unapproved) {?>checked<?}?>> Unapproved
			</div>				
			<div class="col-md-2">
				<button class="form-control" type="button" name="submit"  id="submit">Submit</button>
			</div>				
		</div>
	</div>
	...
	<script>
		$('#submit').click(function() {
			//alert ($('#SubDriver :selected').val());
			var param = "/";
			if ($("#card").is(":checked")) param=param+'1';
			else param=param+'0';			
			if ($("#approved").is(":checked")) param=param+'1';
			else param=param+'0';			
			if ($("#unapproved").is(":checked")) param=param+'1';
			else param=param+'0';
			location.href = 'https://wis.jamtransfer.com/expenses/subdrivers/'+$('#SubDriver :selected').val()+param;			
		})	
