...
<div class="container-fluid container-border">
	<div class="row">
		<div class="col-xs-6">
			<h2>{$details[pom].SubPickupTime}</h2>
		</div>	
		<div class="col-xs-6">	
			<span class="h1 badge badge-dark {$details[pom].cancelstyle}">{$details[pom].OrderID}-{$details[pom].TNo}</span> 
	...
	<div class="row">
		<div class="col-xs-6 h4">	
			...
			{if $details[pom].oeServices|count gt 0}			
				<br><button type="button" class="btn btn-info" data-toggle="modal" data-target="#extras">
