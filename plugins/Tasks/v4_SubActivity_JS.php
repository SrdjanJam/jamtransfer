<script type="text/javascript">
	...
	function all_v4_SubActivity() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_SubActivity/v4_SubActivity_All.php?where='+where+
	...
	function one_v4_SubActivity(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_SubActivity/v4_SubActivity_One.php?ID='+id;
		console.log(url);
	...
	function editSavev4_SubActivity(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_SubActivity/'+
	...
	function editSaveIMGv4_SubActivity() { 
		...
		$.ajax({
			...
			//contentType: "application/json",
			success: function(data, status) {
				img_loc=WEBSITEURL + '/cms/subdriver/uploads/'+data;
