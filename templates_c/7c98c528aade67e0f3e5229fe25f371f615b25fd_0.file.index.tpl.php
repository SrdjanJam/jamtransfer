<?php
/* Smarty version 3.1.32, created on 2022-05-06 11:29:48
  from 'c:\wamp\www\jamtransfer\plugins\PriceRules\templates\index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_627506acc475f0_71847814',
...
function content_627506acc475f0_71847814 (Smarty_Internal_Template $_smarty_tpl) {
echo $_smarty_tpl->tpl_vars['page']->value;?>

<?php echo $_smarty_tpl->tpl_vars['rulesType']->value;?>
	...
	<div class="box-body ">
        <div class="row">
			<div class="col-md-12">
						...
						<input type="text" name="ID" id="ID" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['ID']->value;?>
" readonly>
						<input type="text" name="OwnerID" id="OwnerID" class="w100" value="<?php echo $_SESSION['UseDriverID'];?>
" readonly>
						<input type="text" name="DriverRouteID" id="DriverRouteID" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['item']->value;?>
" readonly>
...
" >
				...
				<div class="row alert alert-warning">
					<div class="col-md-3">
						...
						<input type="text" name="MonPercent" id="MonPercent" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['MonPercent']->value;?>
" >
						<label for="MonAmount"><?php echo $_smarty_tpl->tpl_vars['MONAMOUNT']->value;?>
</label>
						<input type="text" name="MonAmount" id="MonAmount" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['MonAmount']->value;?>
" >
					</div>
					<div class="col-md-3">
						<label for="TuePercent"><?php echo $_smarty_tpl->tpl_vars['TUEPERCENT']->value;?>
</label>
						<input type="text" name="TuePercent" id="TuePercent" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['TuePercent']->value;?>
" >
						<label for="TueAmount"><?php echo $_smarty_tpl->tpl_vars['TUEAMOUNT']->value;?>
</label>
						<input type="text" name="TueAmount" id="TueAmount" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['TueAmount']->value;?>
" >
					</div>
					<div class="col-md-3">
						<label for="WedPercent"><?php echo $_smarty_tpl->tpl_vars['WEDPERCENT']->value;?>
</label>
						<input type="text" name="WedPercent" id="WedPercent" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['WedPercent']->value;?>
" >
						<label for="WedAmount"><?php echo $_smarty_tpl->tpl_vars['WEDAMOUNT']->value;?>
</label>
						<input type="text" name="WedAmount" id="WedAmount" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['WedAmount']->value;?>
" >
					</div>
					<div class="col-md-3">
						<label for="ThuPercent"><?php echo $_smarty_tpl->tpl_vars['THUPERCENT']->value;?>
</label>
						<input type="text" name="ThuPercent" id="ThuPercent" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['ThuPercent']->value;?>
" >
						<label for="ThuAmount"><?php echo $_smarty_tpl->tpl_vars['THUAMOUNT']->value;?>
</label>
						<input type="text" name="ThuAmount" id="ThuAmount" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['ThuAmount']->value;?>
" >
					</div>
				</div>
				...
				<div class="row alert alert-success">
					<div class="col-md-3">
						...
						<input type="text" name="FriPercent" id="FriPercent" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['FriPercent']->value;?>
" >
						<label for="FriAmount"><?php echo $_smarty_tpl->tpl_vars['FRIAMOUNT']->value;?>
</label>
						<input type="text" name="FriAmount" id="FriAmount" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['FriAmount']->value;?>
" >
					</div>
					<div class="col-md-3">
						<label for="SatPercent"><?php echo $_smarty_tpl->tpl_vars['SATPERCENT']->value;?>
</label>
						<input type="text" name="SatPercent" id="SatPercent" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['SatPercent']->value;?>
" >
						<label for="SatAmount"><?php echo $_smarty_tpl->tpl_vars['SATAMOUNT']->value;?>
</label>
						<input type="text" name="SatAmount" id="SatAmount" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['SatAmount']->value;?>
" >
					</div>
					<div class="col-md-3">
						<label for="SunPercent"><?php echo $_smarty_tpl->tpl_vars['SUNPERCENT']->value;?>
</label>
						<input type="text" name="SunPercent" id="SunPercent" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['SunPercent']->value;?>
" >
						<label for="SunAmount"><?php echo $_smarty_tpl->tpl_vars['SUNAMOUNT']->value;?>
</label>
						<input type="text" name="SunAmount" id="SunAmount" class="w100" value="<?php echo $_smarty_tpl->tpl_vars['SunAmount']->value;?>
" >
					</div>
				</div>
