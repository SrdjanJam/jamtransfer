...
<script type="text/javascript">
	...
	function all_v4_PlaceTypes() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_PlaceTypes/v4_PlaceTypes_All.php?where='+where+
	...
	function one_v4_PlaceTypes(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_PlaceTypes/v4_PlaceTypes_One.php?PlaceTypeID='+id;
	...
	function editSavev4_PlaceTypes(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_PlaceTypes/'+
