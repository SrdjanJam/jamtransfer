...
<div class="container">
	...
	<a class="btn btn-primary btn-xs" href="index.php?p=new_v4_Articles"><?= NNEW ?></a>
	<br><br>
	...
	<!-- EXAMPLE !!!
		<div class="col-md-2">
			...
			<select id="UserLevel" class="w75" onchange="all_v4_ArticlesFilter();">
	...
	-->
		...
		<div class="col-md-3">
			...
			<input type="text" id="Search" class=" w75" onkeyup="all_v4_ArticlesFilter();">
		</div>
