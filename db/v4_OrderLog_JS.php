...
<script type="text/javascript">
	...
	function all_v4_OrderLog() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_OrderLog/v4_OrderLog_All.php?where='+where+
	...
	function one_v4_OrderLog(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_OrderLog/v4_OrderLog_One.php?ID='+id;
	...
	function editSavev4_OrderLog(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_OrderLog/'+
