...
<div class="container">
	...
	<a class="btn btn-primary btn-xs" href="index.php?p=new_v4_Services"><?= NNEW ?></a>
	<br><br>
	...
	<!-- EXAMPLE !!!
		<div class="col-md-2">
			...
			<select id="UserLevel" class="w75" onchange="all_v4_ServicesFilter();">
	...
	-->
		...
		<div class="col-md-3">
			...
			<input type="text" id="Search" class=" w75" onkeyup="all_v4_ServicesFilter();">
		</div>

		<div class="col-md-3">
			
			<i class="fa fa-sort-amount-asc"></i> 
			<select name="sortOrder" id="sortOrder" onchange="all_v4_ServicesFilter();">
	...
	<div id="show_v4_Services"><?= THERE_ARE_NO . DATA ?></div>
