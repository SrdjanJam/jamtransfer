...
Class v4_Terminals {
     ...
     *
     */
	public function New_v4_Terminals($TerminalID,$MP,$ImageMP,$ImageBG,$MPOrder,$Description,$LastChange,$Visits){
	...
	public function fieldNames(){
		$fieldNames = array(
			'TerminalID',			'MP',			'ImageMP',			'ImageBG',			'MPOrder',			'Description',			'LastChange',		'Visits'		);
		return $fieldNames;
	}
    /**
