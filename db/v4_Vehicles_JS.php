...
<script type="text/javascript">
	...
	function all_v4_Vehicles() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_Vehicles/v4_Vehicles_All.php?where='+where+
	...
	function one_v4_Vehicles(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Vehicles/v4_Vehicles_One.php?VehicleID='+id;
	...
	function editSavev4_Vehicles(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Vehicles/'+
