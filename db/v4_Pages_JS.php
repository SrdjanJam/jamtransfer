...
<script type="text/javascript">
	...
	function all_v4_Pages() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_Pages/v4_Pages_All.php?where='+where+
	...
	function one_v4_Pages(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Pages/v4_Pages_One.php?ID='+id;
	...
	function editSavev4_Pages(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Pages/'+
