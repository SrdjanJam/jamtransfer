        ...
        <div class="row">
			<div class="col-md-6">
				...
				<div class="row">
					...
					<div class="col-md-9">
						<textarea name="co_homepage" id="co_homepage" rows="5" 
					class="textarea" cols="50" style="width:100%">{{co_homepage}}</textarea>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-9">
						<textarea name="co_desc" id="co_desc" rows="5" 
					class="textarea" cols="50" style="width:100%">{{co_desc}}</textarea>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-9">
						<textarea name="co_terms" id="co_terms" rows="5" 
					class="textarea" cols="50" style="width:100%">{{co_terms}}</textarea>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-9">
						<textarea name="co_refund" id="co_refund" rows="5" 
					class="textarea" cols="50" style="width:100%">{{co_refund}}</textarea>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-9">
						<textarea name="co_privacy" id="co_privacy" rows="5" 
					class="textarea" cols="50" style="width:100%">{{co_privacy}}</textarea>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-9">
						<textarea name="co_howtobook" id="co_howtobook" rows="5" 
					class="textarea" cols="50" style="width:100%">{{co_howtobook}}</textarea>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-9">
						<textarea name="co_htmlblock" id="co_htmlblock" rows="5" 
					class="textarea" cols="50" style="width:100%">{{co_htmlblock}}</textarea>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-9">
						<textarea name="co_sideblock" id="co_sideblock" rows="5" 
					class="textarea" cols="50" style="width:100%">{{co_sideblock}}</textarea>
					</div>
				</div>
