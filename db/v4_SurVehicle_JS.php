...
<script type="text/javascript">
	...
	function all_v4_SurVehicle() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_SurVehicle/v4_SurVehicle_All.php?where='+where+
	...
	function one_v4_SurVehicle(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_SurVehicle/v4_SurVehicle_One.php?ID='+id;
	...
	function editSavev4_SurVehicle(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_SurVehicle/'+
