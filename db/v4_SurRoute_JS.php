...
<script type="text/javascript">
	...
	function all_v4_SurRoute() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_SurRoute/v4_SurRoute_All.php?where='+where+
	...
	function one_v4_SurRoute(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_SurRoute/v4_SurRoute_One.php?ID='+id;
	...
	function editSavev4_SurRoute(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_SurRoute/'+
