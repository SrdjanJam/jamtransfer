...
<script type="text/javascript">
	...
	function all_v4_DaySettings() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_DaySettings/v4_DaySettings_All.php?where='+where+
	...
	function one_v4_DaySettings(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_DaySettings/v4_DaySettings_One.php?ID='+id;
	...
	function editSavev4_DaySettings(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_DaySettings/'+
