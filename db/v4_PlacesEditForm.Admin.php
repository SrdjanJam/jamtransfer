        ...
        <div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-9">
						<input type="text" name="PlaceID" id="PlaceID" class="w100" value="{{PlaceID}}">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-9">
						<input type="text" name="PlaceCountry" id="PlaceCountry" class="w100" value="{{PlaceCountry}}">
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-3">
						<label for="PlaceNameRU"><?=PLACENAMERU;?></label>
					</div>
					<div class="col-md-9">
				...
				<div class="row">
					<div class="col-md-3">
						<label for="PlaceNameFR"><?=PLACENAMEFR;?></label>
					</div>
					<div class="col-md-9">
				...
				<div class="row">
					<div class="col-md-3">
						<label for="PlaceNameDE"><?=PLACENAMEDE;?></label>
					</div>
					<div class="col-md-9">
				...
				<div class="row">
					<div class="col-md-3">
						<label for="PlaceNameIT"><?=PLACENAMEIT;?></label>
					</div>
					<div class="col-md-9">
				...
				<div class="row">
					...
					<div class="col-md-9">
						<input type="text" name="PlaceType" id="PlaceType" class="w100" value="{{PlaceType}}">
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-3">
						<label for="PlaceDescEN"><?=PLACEDESCEN;?></label>
					</div>
					<div class="col-md-9">
				...
				<div class="row">
					<div class="col-md-3">
						<label for="PlaceDescRU"><?=PLACEDESCRU;?></label>
					</div>
					<div class="col-md-9">
				...
				<div class="row">
					<div class="col-md-3">
						<label for="PlaceDescFR"><?=PLACEDESCFR;?></label>
					</div>
					<div class="col-md-9">
				...
				<div class="row">
					<div class="col-md-3">
						<label for="PlaceDescDE"><?=PLACEDESCDE;?></label>
					</div>
					<div class="col-md-9">
				...
				<div class="row">
					<div class="col-md-3">
						<label for="PlaceDescIT"><?=PLACEDESCIT;?></label>
					</div>
					<div class="col-md-9">
				...
				<div class="row">
					...
					<div class="col-md-9">
						<input type="text" name="Island" id="Island" class="w100" value="{{Island}}">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-9">
						<input type="text" name="PlaceActive" id="PlaceActive" class="w100" value="{{PlaceActive}}">
					</div>
				</div>
