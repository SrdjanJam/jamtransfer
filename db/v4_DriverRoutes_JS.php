...
<script type="text/javascript">
	...
	function all_v4_DriverRoutes() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_DriverRoutes/v4_DriverRoutes_All.php?where='+where+
	...
	function one_v4_DriverRoutes(id,inList) { 
		...
		if(inList==true) {
			if ( $("#v4_DriverRoutesWrapper"+id).css('display') != 'none') {$("#v4_DriverRoutesWrapper"+id).hide('slow'); return;}
		}

		// ako element nije prikazan, uzmi potrebne podatke i prikazi ga
		var url = WEBSITEURL + '/cms/p/modules/v4_DriverRoutes/v4_DriverRoutes_One.php?ID='+id;
	...
	function editSavev4_DriverRoutes(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_DriverRoutes/'+
		'v4_DriverRoutes_Save.php?callback=?&keyName=ID&keyValue='+id+'&'+ formData;
