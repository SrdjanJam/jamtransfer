...
<script type="text/javascript">
	...
	function all_v4_Services() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_Services/v4_Services_All.php?where='+where+
	...
	function one_v4_Services(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Services/v4_Services_One.php?ServiceID='+id;
	...
	function editSavev4_Services(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Services/'+
