...
<div class="container">
	...
	<a class="btn btn-primary btn-xs" href="index.php?p=new_v4_SurService"><?= NNEW ?></a>
	<br><br>
	...
	<!-- EXAMPLE !!!
		<div class="col-md-2">
			...
			<select id="UserLevel" class="w75" onchange="all_v4_SurServiceFilter();">
	...
	-->
		<div class="col-md-2">
			<i class="fa fa-eye"></i>
			<select id="length" class="w75" onchange="all_v4_SurServiceFilter();">
		...
		<div class="col-md-3">
			...
			<input type="text" id="Search" class=" w75" onkeyup="all_v4_SurServiceFilter();">
		</div>

		<div class="col-md-3">
			
			<i class="fa fa-sort-amount-asc"></i> 
			<select name="sortOrder" id="sortOrder" onchange="all_v4_SurServiceFilter();">
	...
	<div id="show_v4_SurService"><?= THERE_ARE_NO . DATA ?></div>
	...
	<? 
		...
		// koristi handlebars
		require_once $modulesPath .'/v4_SurService/v4_SurServiceListTemplate.'.$_SESSION['GroupProfile'].'.php'; 
		require_once $modulesPath .'/v4_SurService/v4_SurServiceEditForm.'.$_SESSION['GroupProfile'].'.php'; 
	?>
	<br>
...
<? require_once ROOTPATH.'/p/modules/v4_SurService/v4_SurService_JS.php' ?>	

<script type="text/javascript">
	$(document).ready(function(){
		$(".datepicker").pickadate({format:'yyyy-mm-dd'});
		all_v4_SurService(); // definirano u v4_SurService_JS.php
	});

	function all_v4_SurServiceFilter() {
		all_v4_SurService(); // definirano u v4_SurService_JS.php
	}
</script>	
