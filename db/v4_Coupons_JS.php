...
<script type="text/javascript">
	...
	function all_v4_Coupons() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_Coupons/v4_Coupons_All.php?where='+where+
	...
	function one_v4_Coupons(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Coupons/v4_Coupons_One.php?ID='+id;
	...
	function editSavev4_Coupons(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Coupons/'+
