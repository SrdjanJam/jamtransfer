...
<div class="container">
	...
	<!-- EXAMPLE !!!
		<div class="col-md-2">
			...
			<select id="UserLevel" class="w75" onchange="all_v4_OffDutyFilter();">
	...
	<? 
		...
		// koristi handlebars
		require_once $modulesPath .'/v4_OffDuty/v4_OffDutyListTemplate.'.$_SESSION['GroupProfile'].'.php'; 
		require_once $modulesPath .'/v4_OffDuty/v4_OffDutyEditForm.'.$_SESSION['GroupProfile'].'.php'; 
	?>
	<br>
...
<? require_once ROOTPATH.'/p/modules/v4_OffDuty/v4_OffDuty_JS.php' ?>	
