...
<script type="text/javascript">
	...
	function all_v4_OffDuty() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_OffDuty/v4_OffDuty_All.php?where='+where+
	...
	function one_v4_OffDuty(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_OffDuty/v4_OffDuty_One.php?ID='+id;
	...
	function editSavev4_OffDuty(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_OffDuty/'+
