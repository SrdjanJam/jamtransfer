...
<script type="text/javascript">
	...
	function all_v4_Articles() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_Articles/v4_Articles_All.php?where='+where+
	...
	function one_v4_Articles(id,inList) { 
		...
		if(inList==true) {
			if ( $("#v4_ArticlesWrapper"+id).css('display') != 'none') {$("#v4_ArticlesWrapper"+id).hide('slow'); return;}
		}

		// ako element nije prikazan, uzmi potrebne podatke i prikazi ga
		var url = WEBSITEURL + '/cms/p/modules/v4_Articles/v4_Articles_One.php?ID='+id;
	...
	function editSavev4_Articles(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Articles/'+
