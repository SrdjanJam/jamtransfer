...
<script type="text/javascript">
	...
	function all_v4_Routes() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_Routes/v4_Routes_All.php?where='+where+
	...
	function one_v4_Routes(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Routes/v4_Routes_One.php?RouteID='+id;
	...
	function editSavev4_Routes(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Routes/'+
