...
<script type="text/javascript">
	...
	function all_v4_Comments() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_Comments/v4_Comments_All.php?where='+where+
	...
	function one_v4_Comments(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Comments/v4_Comments_One.php?ID='+id;
	...
	function editSavev4_Comments(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Comments/'+
