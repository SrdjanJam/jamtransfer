...
<script type="text/javascript">
	...
	function all_v4_Survey() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_Survey/v4_Survey_All.php?where='+where+
	...
	function one_v4_Survey(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Survey/v4_Survey_One.php?ID='+id;
	...
	function editSavev4_Survey(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Survey/'+
