...
require_once '../../../../db/v4_OrderStatuses.class.php';


# init class
$db = new v4_OrderStatuses();
...
#********************************
$aColumns = array(
	'OrderStatusID' // dodaj ostala polja!
);
...
$dbTotalRecords = $db->getKeysBy('OrderStatusID ASC', '',$DB_Where);

# test za LIMIT - trebalo bi ga iskoristiti za pagination! 'asc' . ' LIMIT 0,50'
$dbk = $db->getKeysBy('OrderStatusID ' . $sortOrder, '' . $limit , $DB_Where);
