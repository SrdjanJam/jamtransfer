...
#********************************
$aColumns = array(
	'AuthLevelID' // dodaj ostala polja!
);
...
$dbTotalRecords = $db->getKeysBy('AuthLevelID ASC', '',$DB_Where);

# test za LIMIT - trebalo bi ga iskoristiti za pagination! 'asc' . ' LIMIT 0,50'
$dbk = $db->getKeysBy('AuthLevelID ' . $sortOrder, '' . $limit , $DB_Where);
