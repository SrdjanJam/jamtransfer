...
error_reporting(E_PARSE);
	...
	require_once '../../../../db/v4_logTaxido.class.php';
...
if ($keyName != '' and $keyValue != '') $db->getRow($keyValue);
	...
	if(isset($_REQUEST['UserIP'])) { $db->setUserIP($db->myreal_escape_string($_REQUEST['UserIP']) ); } 

		 	
	if(isset($_REQUEST['LogEntry'])) { $db->setLogEntry($db->myreal_escape_string($_REQUEST['LogEntry']) ); } 
