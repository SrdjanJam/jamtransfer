...
require_once '../../../../db/v4_ServicesCopy.class.php';


# init class
$db = new v4_ServicesCopy();
...
$dbTotalRecords = $db->getKeysBy('ServiceID ASC', '',$DB_Where);

# test za LIMIT - trebalo bi ga iskoristiti za pagination! 'asc' . ' LIMIT 0,50'
$dbk = $db->getKeysBy('ServiceID ' . $sortOrder, '' . $limit , $DB_Where);
