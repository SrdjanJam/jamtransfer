...
require_once '../../../../db/v4_Policies_FR.class.php';


# init class
$db = new v4_Policies_FR();
...
$dbTotalRecords = $db->getKeysBy('OwnerID ASC', '',$DB_Where);

# test za LIMIT - trebalo bi ga iskoristiti za pagination! 'asc' . ' LIMIT 0,50'
$dbk = $db->getKeysBy('OwnerID ' . $sortOrder, '' . $limit , $DB_Where);
