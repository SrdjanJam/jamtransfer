...
if ($keyName != '' and $keyValue != '') $db->getRow($keyValue);
	...
	if(isset($_REQUEST['Author'])) { $db->setAuthor($db->myreal_escape_string($_REQUEST['Author']) ); } 

		 	
	if(isset($_REQUEST['EntryTime'])) { $db->setEntryTime($db->myreal_escape_string($_REQUEST['EntryTime']) ); } 
