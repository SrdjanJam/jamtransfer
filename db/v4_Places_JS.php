...
<script type="text/javascript">
	...
	function all_v4_Places() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_Places/v4_Places_All.php?where='+where+
	...
	function one_v4_Places(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Places/v4_Places_One.php?PlaceID='+id;
	...
	function editSavev4_Places(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_Places/'+
