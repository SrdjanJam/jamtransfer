...
Class v4_Services {
	...
	public $ServicePrice1; //decimal(10,2)
	public $ServicePrice2; //decimal(10,2)
	public $ServicePrice3; //decimal(10,2)
     ...
     *
     */
	public function New_v4_Services($SiteID,$OwnerID,$SurCategory,$SurID,$RouteID,$VehicleID,$VehicleTypeID,$VehicleAvailable,$Correction,$ServicePrice1,$ServicePrice2,$ServicePrice3,$Discount,$ServiceETA,$Active,$LastChange){
		$this->SiteID = $SiteID;
	...
	public function saveRow(){
		$result = $this->connection->RunQuery("UPDATE v4_Services set 
...
LastChange = '".$this->myreal_escape_string($this->LastChange)."' WHERE ServiceID = '".$this->ServiceID."'");
	...
	/**
	 * @return ServicePrice1 - decimal(10,2)
	 */
	...
	/**
	 * @return ServicePrice2 - decimal(10,2)
	 */
	...
	/**
	 * @return ServicePrice3 - decimal(10,2)
	 */
