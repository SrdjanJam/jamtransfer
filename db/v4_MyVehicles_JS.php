...
<script type="text/javascript">
	...
	function all_v4_MyVehicles() {
		...
		//
	 	...
	 	var url = WEBSITEURL + '/cms/p/modules/v4_MyVehicles/v4_MyVehicles_All.php?where='+where+
	...
	function one_v4_MyVehicles(id,inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_MyVehicles/v4_MyVehicles_One.php?VehicleID='+id;
	...
	function editSavev4_MyVehicles(id, inList) { 
		...
		var url = WEBSITEURL + '/cms/p/modules/v4_MyVehicles/'+
