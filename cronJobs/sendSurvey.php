...
foreach ($omKeys as $MOrderID) {
	...
	if ($emailsSent < 30 && in_array($MOrderID,$rec3))	{
		...
		$img1Link = 'https://cms.jamtransfer.com/i/logo_hor.png';
		$img2Link = 'https://cms.jamtransfer.com/i/surveyScores.png';
		$returnLink = 'https://cms.jamtransfer.com/survey.php?oid='.$MOrderID;
