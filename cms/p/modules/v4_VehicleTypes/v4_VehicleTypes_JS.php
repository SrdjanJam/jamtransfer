...
<script type="text/javascript">
	...
	function all_v4_VehicleTypes() {
		...
		//
	 	...
	 	var url = window.root + '/cms/p/modules/v4_VehicleTypes/v4_VehicleTypes_All.php?where='+where+
	...
	function one_v4_VehicleTypes(id,inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_VehicleTypes/v4_VehicleTypes_One.php?VehicleTypeID='+id;
	...
	function editSavev4_VehicleTypes(id, inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_VehicleTypes/'+
