...
?>
<div class="container">
	<h1><?= COMPANY_INFO ?> <?= $titleAddOn ?></h1>
	<a class="btn btn-primary btn-xs hidden" href="index.php?p=new_v4_CoInfo"><?= NNEW ?></a>
	<br><br>
		
	<input type="hidden"  id="whereCondition" name="whereCondition" 
	value=" WHERE ID > 0 <?= $dashboardFilter ?>">
	
	<div class="row pad1em hidden" id="searchRow">
		<div class="col-md-2" id="infoShow"></div>

	<!-- EXAMPLE !!!
		<div class="col-md-2">
			<i class="fa fa-list-ul"></i>
			<select id="UserLevel" class="w75" onchange="all_v4_CoInfoFilter();">
	...
	-->
		<div class="col-md-2">
			<i class="fa fa-eye"></i>
			<select id="length" class="w75" onchange="all_v4_CoInfoFilter();">
		...
		<div class="col-md-3">
			...
			<input type="text" id="Search" class=" w75" onkeyup="all_v4_CoInfoFilter();">
		</div>

		<div class="col-md-3">
			
			<i class="fa fa-sort-amount-asc"></i> 
			<select name="sortOrder" id="sortOrder" onchange="all_v4_CoInfoFilter();">
	...
	<div id="show_v4_CoInfo"><?= THERE_ARE_NO . DATA ?></div>
	...
	<? 
		...
		// koristi handlebars
		require_once $modulesPath .'/v4_CoInfo/v4_CoInfoListTemplate.'.$_SESSION['GroupProfile'].'.php'; 
		require_once $modulesPath .'/v4_CoInfo/v4_CoInfoEditForm.'.$_SESSION['GroupProfile'].'.php'; 
	?>
	<br>
...
<? require_once ROOTPATH.'/p/modules/v4_CoInfo/v4_CoInfo_JS.php' ?>	

<script type="text/javascript">
	$(document).ready(function(){
		$(".datepicker").pickadate({format:'yyyy-mm-dd'});
		all_v4_CoInfo(); // definirano u v4_CoInfo_JS.php
	});

	function all_v4_CoInfoFilter() {
		all_v4_CoInfo(); // definirano u v4_CoInfo_JS.php
	}
</script>	
