...
<script type="text/javascript">
	...
	function all_v4_CoInfo() {
		...
		//
	 	...
	 	var url = window.root + '/cms/p/modules/v4_CoInfo/v4_CoInfo_All.php?where='+where+
	...
	function one_v4_CoInfo(id,inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_CoInfo/v4_CoInfo_One.php?ID='+id;
	...
	function editSavev4_CoInfo(id, inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_CoInfo/'+
