...
Class v4_ExtrasMaster {
	...
	public function v4_ExtrasMaster(){
     ...
     *
     */
	public function New_v4_ExtrasMaster($DisplayOrder,$ServiceEN,$ServiceDE,$ServiceRU,$ServiceFR,$ServiceIT,$ServiceSE,$ServiceNO){
...
ServiceNO = '".$this->myreal_escape_string($this->ServiceNO)."' WHERE ID = '".$this->ID."'");
	...
	public function fieldNames(){
		$fieldNames = array(
			'ID',			'DisplayOrder',			'ServiceEN',			'ServiceDE',			'ServiceRU',			'ServiceFR',			'ServiceIT',			'ServiceSE',			'ServiceNO'		);
		return $fieldNames;
	}
    /**
