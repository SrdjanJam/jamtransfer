...
?>
<div class=" container">
	<h1><?= PAGES ?> <?= $titleAddOn ?></h1>
	<? if ($_SESSION["AuthLevelID"] != TRANSLATOR_USER) { ?>
	<a class="btn btn-primary btn-xs" href="index.php?p=newPage"><?= NNEW ?></a>
	<? } ?>
	<br><br>
	...
	<div class="row">
		...
		<div class="col-sm-3">
			...
			<input type="text" id="Search" class=" w75" onchange="all_v4_PagesFilter();" placeholder="Text + Enter to Search">
		</div>
