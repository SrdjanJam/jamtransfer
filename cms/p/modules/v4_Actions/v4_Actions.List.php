...
?>
<div class=" container">
	<h1>Actions <?= $titleAddOn ?></h1>
	<? if ($_SESSION["AuthLevelID"] != TRANSLATOR_USER) { ?>
	<a class="btn btn-primary btn-xs" href="index.php?p=new_v4_Actions"><?= NNEW ?></a>
	<? } ?>
	<br><br>
	...
	<div class="row pad1em">
		...
		<div class="col-md-2">
			<i class="fa fa-eye"></i>
			<select id="length" class="w75" onchange="all_v4_ActionsFilter();">
		...
		<div class="col-md-3">
			...
			<input type="text" id="Search" class=" w75" onchange="all_v4_ActionsFilter();" placeholder="Text + Enter to Search">
		</div>

		<div class="col-md-4">
			
			<i class="fa fa-sort-amount-asc"></i> 
			<select name="sortOrder" id="sortOrder" onchange="all_v4_ActionsFilter();">
	...
	<div id="show_v4_Actions"><?= THERE_ARE_NO . DATA ?></div>
	...
	<? 
		...
		// koristi handlebars
		require_once $modulesPath .'/v4_Actions/v4_ActionsListTemplate.php'; 
		require_once $modulesPath .'/v4_Actions/v4_ActionsEditForm.php'; 
	?>
	<br>
...
<? require_once ROOTPATH.'/p/modules/v4_Actions/v4_Actions_JS.php' ?>	

<script type="text/javascript">
	$(document).ready(function(){
		$(".datepicker").pickadate({format:'yyyy-mm-dd'});
		all_v4_Actions(); // definirano u v4_Actions_JS.php
	});

	function all_v4_ActionsFilter() {
		all_v4_Actions(); // definirano u v4_Actions_JS.php
	}
</script>	
