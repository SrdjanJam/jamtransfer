...
Class v4_Actions {
     ...
     *
     */
	public function New_v4_Actions($DisplayOrder,$Title,$ServiceDE,$ServiceRU,$ServiceFR,$ServiceIT,$ServiceSE,$ServiceNO){
