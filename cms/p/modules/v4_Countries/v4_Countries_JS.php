...
<script type="text/javascript">
	...
	function all_v4_Countries() {
		...
		//
	 	...
	 	var url = window.root + '/cms/p/modules/v4_Countries/v4_Countries_All.php?where='+where+
	...
	function one_v4_Countries(id,inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_Countries/v4_Countries_One.php?CountryID='+id;
	...
	function editSavev4_Countries(id, inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_Countries/'+
