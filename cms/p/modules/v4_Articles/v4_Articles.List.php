...
?>
<div class=" container pad1em fillHeight">
	<h1><?= ARTICLES ?> <?= $titleAddOn ?></h1>
	<a class="btn btn-primary btn-xs" href="index.php?p=newArticle"><?= NNEW ?></a>
	<br><br>
	...
	<div class="row pad1em">
		...
		<div class="col-sm-3">
			<i class="fa fa-eye"></i>
			<select id="length" class="w75" onchange="all_v4_ArticlesFilter();">
		...
		<div class="col-sm-3">
			...
			<input type="text" id="Search" class=" w75" onchange="all_v4_ArticlesFilter();" placeholder="Text + Enter to Search">
		</div>

		<div class="col-sm-3">
			
			<i class="fa fa-sort-amount-asc"></i> 
			<select name="sortOrder" id="sortOrder" onchange="all_v4_ArticlesFilter();">
	...
	<div id="show_v4_Articles"><?= THERE_ARE_NO . DATA ?></div>
	...
	<? 
		...
		// koristi handlebars
		require_once $modulesPath .'/v4_Articles/v4_ArticlesListTemplate.'.$_SESSION['GroupProfile'].'.php'; 
		require_once $modulesPath .'/v4_Articles/v4_ArticlesEditForm.'.$_SESSION['GroupProfile'].'.php'; 
	?>
	<br>
...
<? require_once ROOTPATH.'/p/modules/v4_Articles/v4_Articles_JS.php' ?>	

<script type="text/javascript">
	$(document).ready(function(){
		$(".datepicker").pickadate({format:'yyyy-mm-dd'});
		all_v4_Articles(); // definirano u v4_Articles_JS.php
	});

	function all_v4_ArticlesFilter() {
		all_v4_Articles(); // definirano u v4_Articles_JS.php
	}
</script>	
