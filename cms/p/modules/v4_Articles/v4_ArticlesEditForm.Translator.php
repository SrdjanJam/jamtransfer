...
<form id="v4_ArticlesEditForm{{ID}}" class="form box box-info" enctype="multipart/form-data" method="post" onsubmit="return false;">
	<div class="box-header">
		...
		<div class="box-tools pull-right">
			...
			onclick="postForm();return editSavev4_Articles('{{ID}}', '<?= $inList ?>');">
        ...
        <div class="row">
			<div class="col-md-12">
				...
				<div class="row">
					...
					<div class="col-md-9">
						<textarea name="Article" id="Article{{ID}}" rows="10" 
					class="textarea" cols="50" style="width:100%">{{Article}}</textarea>
					</div>
				</div>
