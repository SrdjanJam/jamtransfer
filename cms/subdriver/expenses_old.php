<?
	...
	$driverId = $_SESSION['DriverID'];
	        ...
	        $Balance = $p->Primljeno - $t->Trosak + $auf->Balance; 
	...
	$opis = array(
		...
		'10' => 'Dijelovi za auto',
		'11' => 'Vozac predao direktoru',
		'12' => 'Administrator predao direktoru',
		'13' => 'Vozac predao Antoniu',
		'14' => 'Vozac predao Nikši',
		'15' => 'Vozac predao Peri',
		'16' => 'Vozac predao Damiru',	
		'17' => 'Naplata karticom',
		'18' => 'Vozac predao Danijeli',	
		'19' => 'Vozac predao Milošu',				
		'99' => 'Ostalo');
...
<div class="container white">
	...
	<div class="row">
		<div class="col-xs-12 pad1em">
		    ...
		    ?>
			<div class="col-md-4">
				<h4 title="=> 01.08.2018">Deposit (Polog): <span class="bold <?= $warningClass ?>"><?= nf($Deposit) ?> EUR</span></h4>
			</div>
			<div class="col-md-4">
