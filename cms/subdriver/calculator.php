...
<div class="container white">
    ...
    <div style="text-align:center;margin-top:36px;font-size:large">
        <input id="ExchangeValue" type="number" step="0.01" placeholder="0" onkeyup="updateER()" style="width:7em" >
        ...
        <input id="ExchangeValue2" type="number" step="0.01" placeholder="0" onkeyup="updateER2()" style="width:7em">		
		EUR
