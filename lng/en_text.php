...
// 26.6.23 =======================================================
define("FLIGHT_TIME_CHECKER","Flight Time Checker");
define("CHECKER","Checker");
define("LIST_ORDER", "List");
define("REPORTER", "Reporter");
define("FROM_DATE", "From Date");
define("NAME_ID", "Name/ID");
define("ORDER_KEY_AGENT_ORDER", "Order Key / Agent Order");
define("LOCATION_NAME", "Location Name");
define("PASSENGER_DATA", "Passenger Data");
define("PAYMENT_INVOICE_NO", "Payment / Invoice No");
define("DETAIL_PRICE", "DetailPrice");
define("EXTRA_CHARGE", "ExtraCharge");
